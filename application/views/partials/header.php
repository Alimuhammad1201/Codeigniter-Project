...
<title><?php echo $title ?> | Titan Laptops</title>
      ...
      <div class="table-container">
        ...
        <div class="col-table-cell col-lg-3 col-md-3 col-sm-6 col-xs-12 inner">
          ...
          <div id="search" class="input-group">
            <input id="s" type="text" name="s" value="<?php echo ($this->input->get('s')) ? $this->input->get('s') : null; ?>" placeholder="Search" class="form-control input-lg" />
