<aside id="column-left" class="col-sm-3 hidden-xs">
  ...
  <div class="side-item">
    ...
    <div class="product-thumb clearfix">
      <div class="image"><a href="<?php echo '/product/' . $latest_product->slug; ?>"><img src="/uploads/<?php echo $latest_product->product_img; ?>" width="50" height="50" alt="<?php echo $latest_product->title; ?>" title="<?php echo $latest_product->title; ?>" class="img-responsive" /></a></div>
      <div class="caption">
  ...
  <div class="side-item">
    ...
    <div class="product-thumb clearfix">
      <div class="image"><a href="<?php echo '/product/' . $most_view->slug; ?>"><img src="/uploads/<?php echo $most_view->product_img; ?>" width="50" height="50" alt="<?php echo $most_view->title; ?>" title="<?php echo $most_view->title; ?>" class="img-responsive" /></a></div>
      <div class="caption">
