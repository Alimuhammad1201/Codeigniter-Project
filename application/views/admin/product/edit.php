<div class="page-content">
    <div class="content">
        ...
        $hidden = ['img_url' => $product->product_img];
                        ...
                        <div class="row column-seperation">
                            ...
                            <h4>Basic Information</h4>            
                              <div class="row form-row">
                                <div class="col-md-12">
                                  ...
                                  <input name="create_date" id="create_date" type="text"  class="form-control <?php echo form_error('create_date') ? 'error' : Null; ?>" placeholder="Create Date"   value="<?php echo $product->create_date; ?>">
                                  <?php echo form_error('create_date', '<div class="alert alert-danger">', '</div>'); ?>
                                </div>
                              </div>
                              <div class="row form-row">
                                <div class="col-md-12">
                                  <select name="brand_id" id="brand_id" class="form-control"   value="<?php echo $product->brand_id; ?>">
                                    <option value="0">:: Select Brand ::</option>
                                    <?php foreach ($brands as $brand): ?>
                                      <option value="<?php echo $brand->id; ?>" <?php echo ($brand->id == $product->brand_id) ? 'selected' : NULL; ?>><?php echo $brand->title; ?></option>
                                    <?php endforeach ?>
                                </div>
                              </div>
                              <div class="row form-row">
                                <div class="col-md-12">
                                  <input name="title" id="title" type="text"  class="form-control <?php echo form_error('title') ? 'error' : Null; ?>" placeholder="Title"  value="<?php echo $product->title; ?>">
                              ...
                              <div class="row form-row">
                                <div class="col-md-12">
                                  <input name="slug" id="slug" type="text"  class="form-control <?php echo form_error('slug') ? 'error' : Null; ?>" placeholder="Slug"   value="<?php echo $product->slug; ?>">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="row form-row">
                              ...
                              <div class="row form-row">
                                <div class="col-md-12">
                                  <textarea name="views" id="views" rows="8" class="form-control" placeholder="Views"><?php echo set_value('views'); ?><?php echo $product->views; ?></textarea>
                                </div>
                              </div>
                              <div class="row form-row">
                                <div class="col-md-12">
