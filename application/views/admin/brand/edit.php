<div class="page-content"> 
    <div class="content">  
      ...
      <?php
      $attributes = ['name' => 'form_edit', 'id' => 'form_edit'];
                            ...
                            <div class="col-md-6">
                              <h4>Basic Information</h4>            
                                <div class="row form-row">
                                  <div class="col-md-12">
                                    <input name="create_date" id="create_date" type="text"  class="form-control <?php echo form_error('create_date') ? 'error' : NULL; ?>"  placeholder="Date"  value="<?php echo $brand->create_date; ?>">
                                ...
                                <div class="row form-row">
                                  <div class="col-md-12">
                                    <input name="title" id="title" type="text"  class="form-control <?php echo form_error('title') ? 'error' : NULL; ?>" placeholder="Title"  value="<?php echo $brand->title; ?>">
                                ...
                                <div class="row form-row">
                                  <div class="col-md-12">
                                    <input name="slug" id="slug" type="text"  class="form-control <?php echo form_error('slug') ? 'error' : NULL; ?>" placeholder="Slug"  value="<?php echo $brand->slug; ?>">
